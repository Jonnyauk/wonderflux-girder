...
<div id="post-<?php the_ID(); ?>" <?php wfx_post_class(''); ?>>
	...
	<div id="nav-posts" class="navigation">
		<div class="nav-previous"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'wonderflux' ) . '</span> %title' ); ?></div>
		<div class="nav-next"><?php next_post_link( '%link', '%title <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'wonderflux' ) . '</span>' ); ?></div>
	</div>
